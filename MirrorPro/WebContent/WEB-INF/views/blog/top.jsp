...
<html lang="zh-CN">
  ...
  <body>
    ...
    <div class="blog-masthead">
      <div class="container">
        <nav class="blog-nav">
          <a class="blog-nav-item active" href="http://182.61.4.43/" target="_parent">Schizophrenia Laboratory</a>
          <a class="blog-nav-item rightbtn" href="javascript:window.parent.signIn();">Register</a>
          <a class="blog-nav-item rightbtn" href="javascript:window.parent.signIn();">Sign In</a>        
        </nav>
      </div>
